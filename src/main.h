...
static const int COINBASE_MATURITY_VDC = 10;
...
static const int64 GENESIS_BLOCK_TIME = 1473264000;
...
static const uint256 hashGenesisBlockOfficial("0x0000000a75f6b852b28a495ef44b7b1a2027ad44c66cae15bcd38e1f458c0811");
...
public:
    ...
    {
        // vdc: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // vdc: get transaction coin age
...
public:
    ...
    // vdc: block signature - signed by coin base txout[0]'s owner
    ...
    // vdc: two types of block: proof-of-work or proof-of-stake
    ...
    // vdc: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // vdc: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // vdc: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // vdc: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // vdc: block index flags
    enum  
    {
