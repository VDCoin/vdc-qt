...
namespace Checkpoints
{
    ...
    // vdc: synchronized checkpoint (centrally broadcasted)
    ...
    // vdc: get last synchronized checkpoint
    ...
    // vdc: only descendant of current sync-checkpoint is allowed
    ...
    // vdc: reset synchronized checkpoint to last hardened checkpoint
...
//#1
// vdc: sync-checkpoint master key
...
// vdc: verify signature of sync-checkpoint message
...
// vdc: process synchronized checkpoint
